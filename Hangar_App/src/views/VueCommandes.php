        ...
        <body>
            ...
            <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
                <div class="container px-lg-5 ">
                    <a class="navbar-brand justi" href="./espaceProducteur.html">Hangar Local <br>Espace producteur</a>
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul id="tabs" class="navbar-nav ms-auto mb-2 mb-lg-0">
                            <ul id="tabs" class="navbar-nav ms-auto mb-2 mb-lg-0">
                                ...
                                <li class="nav-item"><a href="./mesCommandes.html" id="commandes" class="nav-link active">Commandes</a></li>
                            </ul>
                        </ul>
                    </div>
                </div>
